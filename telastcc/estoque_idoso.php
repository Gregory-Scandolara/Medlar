...
<body>
    <div id="titulo_idoso" class="titulo">
        ...
        <div class="tit">
            <h2>ESTOQUE DO IDOSO</h2>
            <h5>ESTOQUE DO IDOSO</h5>
        </div>
    </div>
    <?php
    ...
    <div id="lista-estoque">
        ...
        <form action="estoque_idoso.php?ididoso=<?php echo $ididoso ?>" method="POST" name="pesquisa_remed">
            <div class="wrap">
                <div class="search">
        ...
        <table id="estoq" class="table table-info table-striped">
            ...
            <tbody>
                ...
                <?php
                if (isset($_POST['pesquisa_remed'])) {
                    $pesquisa_remed = "%" . trim($_POST['pesquisa_remed']) . "%";
                    $sql = "select * from estoque_idoso, medicamentos WHERE estoque_idoso.idremed = medicamentos.idremedio and estoque_idoso.ididoso = $ididoso and medicamentos.nome_remed LIKE '$pesquisa_remed' order by medicamentos.nome_remed";
                } else {
                    $sql = "select * from estoque_idoso, medicamentos WHERE estoque_idoso.idremed = medicamentos.idremedio and estoque_idoso.ididoso = $ididoso order by medicamentos.nome_remed";
                }
    ...
    <td id="some">
        <div class="botao pergunta"><a id="cadastro" style=" padding: 5;" class='btn btn-secondary btn-sm' href='editar_estoque_idoso.php?idremedio=<?php echo $linha['idremedio'] ?>&ididoso=<?= $ididoso ?>'><svg xmlns="http://www.w3.org/2000/svg" margin-bottom="10px" position: relative width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                    <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z" />
                </svg></a></div>
    </td>
    <td id="some">
        <div class="botao pergunta"><a id="cadastro" style=" padding: 5;" class='btn btn-success btn-sm' name='btnSalvar' href='cadastro_estoque_idoso.php?idremedio=<?php echo $linha['idremedio'] ?>&ididoso=<?= $ididoso ?>'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z" />
                </svg></a></div>
    </td>
    </tr>
