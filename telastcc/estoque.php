            ...
            <tbody>
                ...
                while ($linha = mysqli_fetch_array($rs)) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="botao"><a id="cadastro" style=" padding: 17; width: 0px; height: 0px" class='btn btn-secondary btn-sm' href='editaridoso.php?ididoso=<?php echo $ididoso ?>'><svg xmlns="http://www.w3.org/2000/svg" margin-bottom="10px" position: relative width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
